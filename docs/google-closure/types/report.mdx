...
20. [REPORTED](https://github.com/google/closure-compiler/issues/4041) Array methods such as filter,map, forEach, reduce are not getting type-checked
21. [REPORTED](https://github.com/google/closure-compiler/issues/4042) Object rest operator does not get type checked correctly.
22. [REPORTED](https://github.com/google/closure-compiler/issues/4043) Configuring source maps is a pain
