...
# TODO
1. Finish WIP
   1. GC by default allows access to [subcalss props but they are unknown (only old style defined classes such as Element) ](https://github.com/google/closure-compiler/wiki/Conformance:-Sources-of-%22unknown%22) is a similar fashion it allows access to any attributes of union type but they are unkown as well
   2. TODO Object spread does not type check - https://github.com/google/closure-compiler/issues/3132
2. try `goog.require`, `goog.import`
3. How to import libraries?
4. pollyfills
5. Read again and discuss all compiler flags
6. Read all wiki pages (71) https://github.com/google/closure-compiler/wiki
7. Read community https://developers.google.com/closure/compiler/community
